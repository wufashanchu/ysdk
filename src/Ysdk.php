...
use Ysdk\lib\SnsNetwork;
use Ysdk\lib\SnsSigCheck;
...
class Ysdk
{
    ...
    const OPENAPI_ERROR_CURL = 1900;// 网络错误, 偏移量1900
     ...
     * @return array 结果数组
     */
    public function apiYsdk($script_name, $params,  $method='post', $protocol='http')
    {
    ...
    public function apiPay($script_name,$accout_type,$params,$method='post', $protocol='http')
    {
		...
		{
			return self::OPENAPI_ERROR_REQUIRED_PARAMETER_INVALID;
		}
